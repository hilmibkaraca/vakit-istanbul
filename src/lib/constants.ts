...
export const ADSENSE_SLOTS = {
  ...
  CONTENT_SQUARE: process.env.NEXT_PUBLIC_ADSENSE_SQUARE_SLOT || '0987654321',
  FOOTER_BANNER: process.env.NEXT_PUBLIC_ADSENSE_FOOTER_SLOT || '1122334455',
  RESPONSIVE: process.env.NEXT_PUBLIC_ADSENSE_RESPONSIVE_SLOT || '5566778899'
};
